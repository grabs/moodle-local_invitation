...
$string['invitation_created'] = 'Inventation successfully created.';
$string['invitation_updated'] = 'Inventation successfully updated.';
$string['invite_participants'] = 'Create new invitation';
$string['join'] = 'Join';
