...
$string['available_from'] = 'Link verwendbar von:';
$string['available_to'] = 'Link verwendbar bis:';
...
$string['delete_confirmation'] = 'Soll die aktuelle Einladung gelöscht werden? Der Einladungslink kann anschließend nicht mehr verwendet werden.';
...
$string['guestuser_suffix'] = '(Gastnutzer)';
...
$string['invitation_created'] = 'Die Einladung wurde erfolgreich erstellt.';
$string['invitation_delete_note_timeandlogout'] = 'Der temporäre Zugang und die damit verbundenen Daten werden automatisch gelöscht, sobald sich die Person abmeldet, spätestens aber {$a} nach der Verwendung.';
$string['invitation_delete_note_timeonly'] = 'Der temporäre Zugang und die damit verbundenen Daten werden spätestens {$a} nach der Verwendung automatisch gelöscht.';
$string['invitation_deleted'] = 'Die Einladung wurde erfolgreich gelöscht';
$string['invitation_note'] = 'Mithilfe der Einladungsfunktion können Sie einen Link für einen <strong>temporären Zugang</strong> zu diesem Kurs erstellen. Über den hier erstellten Einladungslink können Personen ohne eigenes Lernraum-Benutzerkonto <strong>einmalig und temporär</strong> diesen Kurs betreten, z. B. für einen Elternabend per Videokonferenz.';
$string['invitation_updated'] = 'Die Einladung wurde erfolgreich aktualisiert.';
$string['invite_participants'] = 'Neue Einladung für temporären Kurszugang';
$string['join'] = 'Teilnehmen';
$string['link_copied'] = 'Der Link wurde kopiert.';
$string['max_users'] = 'Maximale Anzahl Teilnehmer';
$string['max_users_per_invitation'] = 'Maximale Anzahl Teilnehmer je Einladung';
$string['nameinfo'] = 'Namensinformation';
$string['nameinfo_help'] = 'Mit diesem Text kann eine kurze Erklärung definiert werden, die bei neuen Gastnutzern im Einladungsdialog angezeigt wird.';
$string['note'] = 'Hinweis:';
...
$string['welcome_note'] = 'Herzlich Willkommen {$a->firstname} {$a->lastname}!';
